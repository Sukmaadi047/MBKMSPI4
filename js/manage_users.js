    ...
    $.ajax({
      ...
      success: function(response){
        ...
        if (response == 1) {
          ...
          $('.alert_user').html('<p class="alert alert-success">User baru berhasil terdaftar</p>');
        }
        else{
          $('.alert_user').fadeIn(500);
    ...
    $.ajax({
      ...
      success: function(response){
        ...
        if (response == 1) {
          ...
          $('#dev_sel').val('0');
          $('.alert_user').fadeIn(500);
          $('.alert_user').html('<p class="alert alert-success">User berhasil di update!</p>');
        }
        else{
          $('.alert_user').fadeIn(500);
          $('.alert_user').html('<p class="alert alert-danger">'+ response + '</p>');
        ...
        $.ajax({
          ...
          success: function(response){
            ...
            if (response == 1) {
              ...
              $('#dev_sel').val('0');
              $('.alert_user').fadeIn(500);
              $('.alert_user').html('<p class="alert alert-success">User berhasil di delete!</p>');
            }
            else{
              $('.alert_user').fadeIn(500);
              $('.alert_user').html('<p class="alert alert-danger">'+ response + '</p>');
  ...
  $(document).on('click', '.select_btn', function(){
    ...
    $.ajax({
      ...
      success: function(response){
        ...
        $('.alert_user').fadeIn(500);
        $('.alert_user').html('<p class="alert alert-success">User terpilih!</p>');
        ...
        for (var i = 0; i < len; i++) {
            ...
            user_on.User_on.push(response[i].nomer_induk);
