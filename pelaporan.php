    ...
    <div class="row">
      <div class="col-lg-6 mb-5 mb-lg-0">
        <form action="" method="POST" class="contact-form py-5 px-lg-5">
          <h2 class="mb-4 font-weight-medium text-secondary">Pelaporan Covid-19</h2>
          ...
          <div class="row form-group">
            ...
            <div class="col-md-12">
              <label class="text-black" for="subject">Jurusan</label>
              <input type="text" name="jurusan" id="subject" class="form-control" required>
            </div>
          </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-md-12">
              <label class="text-black" for="subject">Nim</label>
              <input type="text" name="nim" id="subject" class="form-control" required>
            </div>
          </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-md-12">
              <label class="text-black" for="subject">Tanggal</label>
          ...
          <div class="row form-group">
            ...
            <div class="col-md-12">
              ...
              <input type="text" name="alamat" id="subject" class="form-control" required>
            </div>
          </div>
