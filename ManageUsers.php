	...
	<div class="form-style-5 slideInDown animated">
		<form enctype="multipart/form-data">
			...
			<fieldset>
				...
				<input type="text" name="number" id="number" placeholder="Nomer Induk...">
				<input type="email" name="email" id="email" placeholder="User Email...">
			</fieldset>
			<fieldset>
			<legend><span class="number">2</span> Additional Info</legend>
			<label>
				<label for="Device"><b>User Akses:</b></label>
				...
				<input type="radio" name="gender" class="gender" value="Wanita">Wanita
	          	<input type="radio" name="gender" class="gender" value="Pria" checked="checked">Pria
	      	</label >
			</fieldset>
